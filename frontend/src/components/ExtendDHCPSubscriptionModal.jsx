...
const ExtendDHCPSubscriptionModal = ({ closeExtendDHCPSubscriptionModal, serviceID }) => {
    ...
    useEffect(() => {
        const fetchSchedule = async () => {
            setLoading(true);
            try {
                const res = await api.get(`/api/clients/dhcp/${serviceID}/`);
    ...
    return loading ? <WaveLoader /> : (
        <div className="fixed inset-0 z-50 flex items-start justify-center">
            <div className="fixed inset-0 bg-gray-900 bg-opacity-50" onClick={closeExtendDHCPSubscriptionModal}></div>
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg mt-10 transform transition-transform duration-300">
                <div className="flex items-center mb-4">
                    <FontAwesomeIcon
                        ...
                        onClick={closeExtendDHCPSubscriptionModal}
                        title="Close"
                    />
            ...
            <SuccessModal
                ...
                onClose={() => {
                    ...
                    closeExtendDHCPSubscriptionModal();
                }}
...
export default ExtendDHCPSubscriptionModal;
