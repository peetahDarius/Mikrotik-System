                ...
                <thead className="bg-gray-800">
                  <tr>
                    {[
                      ...
                      { label: "Full Name", field: "secret.client.first_name" },
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredSecrets.map((secret) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-4 text-sm text-gray-500">{secret.name}</td>
                      ...
                      <td className="px-3 py-4 text-sm text-gray-900">{secret.package}</td>
                      <td className="px-3 py-4 text-sm text-gray-900">{secret.ip_address}</td>
                      { secret.is_suspended ? 
                      ...
                      <td className="px-3 py-4 text-sm text-gray-900">{ <DHCPClientStatus serviceName={secret.name}/> }</td>
